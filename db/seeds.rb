...
topics = Topic.create!(
  [
    ...
    {end_user_id: end_users[3].id, community_id: communities[3].id, title: '心に残った言葉、フレーズ', body: "心に残る言葉、フレーズが本にはあるもの\n\n本の中で皆様の心に残った言葉、フレーズ、せりふでもいいです。\n\n教えてください。"},
    ...
    # {end_user_id: end_users[3].id, community_id: communities[4].id, title: '○月○日(○)　休日の読書会　開催します', body: "文芸書に特化した読書会です。\n\nレンタルルームで、心置きなく本の話をしましょう。"},
    ...
    {end_user_id: end_users[6].id, community_id: communities[7].id, title: '京都で行きたいところ part1', body: "行きたいところを好きかって書くところ。\n行きたいところ教えてください。こだわりをぶつけてください。\n\nかかれたところが、知っているところなら情報ください。"},
    {end_user_id: end_users[6].id, community_id: communities[7].id, title: '◆京都グルメ情報 part1', body: "京都の食は奥が深い。\n京都らしいおいしさを持つ穴場の情報。"},
    ...
    {end_user_id: end_users[7].id, community_id: communities[8].id, title: 'ボードゲームな日記を書いたら報告するトピック', body: "【イベントの概要】\n・こんなゲームをやりました\n・とあるボードゲームの考察を書いてみた\n・ボードゲームイベント参加報告\n・自作ボードゲームについて️\n\nなどなど、ボードゲーム関連の日記を書いたら報告するトピ"},
  ]
)
