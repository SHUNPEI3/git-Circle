...
communities = Community.create!(
  [
    ...
    {name: 'ボードゲーム会', introduction: "国産から海外のものまで、真剣になっちゃうものから、笑っちゃうようなものまで何でもあります！\n\n男性のほかに、女性の主催者もいますので、女性の方も安心してご参加くださいね！\n\nボードゲーム自体初めての方も、月に何回もボードゲームをやってる方も、本イベント初参加の方も、参加されたことのある方も、みんなで楽しくやりましょう！", owner_id: end_users[7].id, community_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-community8.jpg"), filename:"sample-community8.jpg")},
  ]
)
